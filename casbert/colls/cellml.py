...
class Cellmls(PmrCollection):
    ...
    def showStatistic(self):
        ...
        summary = {0: {'tot': 0, 'isRdf': 0, 'isAnnotated': 0, 'isSemgen': 0}, 1: {
            'tot': 0, 'isRdf': 0, 'isAnnotated': 0, 'isSemgen': 0}}
